...
const AdminProfile = () => {
    ...
    if (isLoading) return <p className="text-center py-10 text-xl">Loading...</p>;
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-100 to-pink-50 p-4 lg:p-10">
            ...
            >
                <div className="flex flex-col bg-gradient-to-t from-orange-600 via-amber-300 to-orange-400 items-center gap-4 p-6 rounded-2xl shadow-md w-full mx-auto lg:w-1/2">
                    {/* Profile Image & Badge */}
                    <div className="relative">
                        <img
                            src={user?.photoURL}
                            alt="Admin"
                            className="w-32 h-32 lg:w-40 lg:h-40 rounded-full shadow-lg object-cover ring-4 ring-white"
                        />
